...
import com.example.lorelocker.databinding.ActivityStoryVaultBinding

class StoryVault : AppCompatActivity() {

    private lateinit var binding: ActivityStoryVaultBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityStoryVaultBinding.inflate(layoutInflater)
        setContentView(binding.root)

        val vaultName = "story_vault"
        db = NotesDatabaseHelper(this, vaultName)
        db.tableValidation()

        notesAdapter = NotesAdapter(db.getAllNotes(), this, "story_vault")
