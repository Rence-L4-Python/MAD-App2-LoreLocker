...
import com.example.lorelocker.databinding.ActivityLoreVaultBinding

class LoreVault : AppCompatActivity() {

    private lateinit var binding: ActivityLoreVaultBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityLoreVaultBinding.inflate(layoutInflater)
        setContentView(binding.root)

        val vaultName = "lore_vault"
        db = NotesDatabaseHelper(this, vaultName)
        db.tableValidation()

        notesAdapter = NotesAdapter(db.getAllNotes(), this, "lore_vault")
