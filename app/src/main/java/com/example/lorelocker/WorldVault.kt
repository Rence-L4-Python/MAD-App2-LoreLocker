...
import com.example.lorelocker.databinding.ActivityWorldVaultBinding

class WorldVault : AppCompatActivity() {

    private lateinit var binding: ActivityWorldVaultBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityWorldVaultBinding.inflate(layoutInflater)
        setContentView(binding.root)

        val vaultName = "world_vault"
        db = NotesDatabaseHelper(this, vaultName)
        db.tableValidation()

        notesAdapter = NotesAdapter(db.getAllNotes(), this, "world_vault")
